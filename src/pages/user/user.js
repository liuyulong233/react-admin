...
export default function User() {
  ...
  const columns = [
...

    {
      ...
      dataIndex: "avatar",
      align: "center",
      render: (value, record) =>  <Avatar src={record.avatar} />,
    },
    {
      title: "角色",
      dataIndex: "role",
      align: "center",
      render: (value, record) =>
       <Tag color="#2db7f5">{record.role}</Tag>,
    },
    { title: "手机号", dataIndex: "mobile", align: "center" },
    {
      ...
      dataIndex: "status",
      align: "center",
      render: (value, record) => <span>{record.status ? "不是" : "是"}</span>,
    },
      ...
      render: (value, record) => {
        ...
        return (
          <div className="flex justify-between">
           <AuthButton auth="user:r">
              <Button type="primary" onClick={() => handleView(_id)}>
                查看
              </Button>
            </AuthButton>
            <AuthButton auth="user:u">
              <Button
                type="primary"
