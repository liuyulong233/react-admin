...
export default function Config() {
  ...
  const columns = [
    ...
    // },
    { title: "应用appid", dataIndex: "appid", align: "center",width:150 },
    { title: "应用名称", dataIndex: "name", align: "center" },
    { title: "更新标题", dataIndex: "title", align: "center",ellipsis:true },
    { title: "更新内容", dataIndex: "content", align: "center" ,ellipsis:true},
    {
      title: "类型",
      dataIndex: "type",
      align: "center",
    ...
    },
    {
      ...
      dataIndex: "status",
      align: "center",
      render: (value, record) => record.status?"有效" : "无效" 
    },
